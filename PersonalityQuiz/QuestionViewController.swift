...
class QuestionViewController: UIViewController {
    ...
    let questions: [Question] = [
        ...
        Question(text: "How much do you enjoy car rides?",
                 type: .ranged,
                 answers: [
                    Answer(text: "I dislike them",         type: .cat),    //left
                    Answer(text: "I get a little nervous", type: .rabbit),
                    Answer(text: "I barely notice them",   type: .turtle),
                    Answer(text: "I love them",            type: .dog)     //right
                ]
        )
    ];
    ...
    override func viewDidLoad() {
     ...
     override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ResultsSegue" {
            ...
            // Pass the answerChosen to the new view controller.
    ...
    @IBAction func rangedAnswerButtonPressed() {
        ...
        let index: Int = Int(round(rangedSlider.value * Float(currentAnswers.count - 1)));
    ...
    func updateUI() {
        ...
        let currentAnswers: [Answer] = currentQuestion.answers;
    ...
    func updateRangedStack(using answers: [Answer]) {
        ...
        rangedLabel1.text = answers.first?.text;   //optional chaining
